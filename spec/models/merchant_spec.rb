...
RSpec.describe Merchant do
  ...
  describe 'Instance Methods' do
    before :each do
      ...
      @order_1 = @user_1.orders.create!(status: 0, address_id: @address_1.id)
			@order_2 = @user_1.orders.create!(status: 1, address_id: @address_2.id)
			@order_3 = @user_1.orders.create!(status: 1, address_id: @address_2.id)
